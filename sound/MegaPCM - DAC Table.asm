...
ptr_dac91:	dcSample	TYPE_PCM, Bongo, 9806					; $91	- Low-Bongo
	...
	if SMPS_S3DACSamples||SMPS_SKDACSamples||SMPS_S3DDACSamples
		; Sonic 3 & K & 3D
ptr_dac92:	dcSample	TYPE_PCM, SnareS3, 9090				; $92	- Snare (S3)
ptr_dac93:	dcSample	TYPE_PCM, TomS3, 8274					; $93	- Hi-Tom (S3)
ptr_dac94:	dcSample	TYPE_PCM, TomS3, 4050					; $94	- Mid-Tom (S3)
ptr_dac95:	dcSample	TYPE_PCM, TomS3, 6599					; $95	- Low Tom (S3)
ptr_dac96:	dcSample	TYPE_PCM, TomS3, 7490					; $96	- Floor-Tom (S3)
ptr_dac97:	dcSample	TYPE_PCM, KickS3, 11090					; $97	- Kick (S3)
ptr_dac98:	dcSample	TYPE_PCM, MuffledSnare, 9090			; $98	- Muffled Snare
...
ptr_dacA9:	dcSample	TYPE_PCM, TimpaniS3, 8852				; $A9	- Hi-Timpani (S3)
ptr_dacAA:	dcSample	TYPE_PCM, TimpaniS3, 6358				; $AA	- Low-Timpani (S3)
ptr_dacAB:	dcSample	TYPE_PCM, TimpaniS3, 5492				; $AB	- Mid-Timpani (S3)
ptr_dacAC:	dcSample	TYPE_PCM, SnareS33, 8279				; $AC	- Quick Loose Snare
